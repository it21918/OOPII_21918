...
public class Main {
	...
	public static void freeTicket(ArrayList<Traveller> travellers, City obj) {
	...
	public static void main(String[] args)
		...
		// about him.
		travellers.get(0).setVatNumber(vatNumber);
		...
		// 0 (Athens)
		freeTicket(travellers, city.get(0));
